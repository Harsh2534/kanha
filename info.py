...
#main variables
API_ID = int(environ.get('API_ID', '28224571'))
API_HASH = environ.get('API_HASH', '2b9ed2026bc5312b81ace929586eb811')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002183598509'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002227062393'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002230267887'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002235566198'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002236938273')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002151745617'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002228918974')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002235566198'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002174558877'))
